    ...
    <footer className="bg-[#0e3b39] text-white py-16">
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-4 gap-8">
          <div>
            <Logo />
            <p className="text-gray-300 font-bricolage mb-6">
        ...
        <div className="mt-12 pt-8 border-t font-bricolage border-white/10 text-center text-gray-400">
          <p className="font-bricolage">
            &copy; {new Date().getFullYear()} Empowered for Progress. All rights
            reserved.
          </p>
        </div>
      </div>
